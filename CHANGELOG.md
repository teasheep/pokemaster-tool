...
- **首頁看得出是哪一款遊戲**：拍組看板每一列帶「訓練家在前、寶可夢在後」的疊圓頭像，
  道館戰看板的示範成員用他們自己的訓練家立繪當頭貼，背後再加一層散落、各自慢慢浮動的
  拍組頭像（中央挖空，字上面永遠不會有東西；手機整層不渲染）。
  進場時文案 → 看板 → CTA 依序淡入上浮，長條從 0 掃到實際值。
  全部只吃既有的 128px WebP：手機 14 張 / 72KB，桌機 26 張 / 130KB。
